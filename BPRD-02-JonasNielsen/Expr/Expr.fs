...
let rec fmt1 (e : expr) : string = 
    match e with
      ...
      | _ -> failwith "NotImplemented fmt1 Expr.fs"
...
let rec fmt2 (ctxpre : int) (e : expr) = 
    match e with
      ...
      | _ -> failwith "NotImplemented fmt2 Expr.fs"
...
let rec eval (e : expr) (env : (string * int) list) : int =
    match e with
      ...
      | _ -> failwith "NotImplemented eval Expr.fs"
...
let rec closedin (e : expr) (env : string list) : bool =
    match e with 
      ...
      | _ -> failwith "NotImplemented closedin Expr.fs"
...
let rec freevars e : string list =
    match e with 
      ...
      | _ -> failwith "NotImplemented freevars Expr.fs"
...
let rec tcomp e (cenv : string list) : texpr =
    match e with
      ...
      | _ -> failwith "NotImplemented tcomp Expr.fs"
...
let rec teval (e : texpr) (renv : int list) : int =
    match e with
      ...
      | _ -> failwith "NotImplemented teval Expr.fs"
...
let rec scomp e (cenv : rtvalue list) : sinstr list =
    match e with
      ...
      | _ -> failwith "NotImplemented scomp Expr.fs"
